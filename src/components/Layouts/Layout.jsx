...
const Layout = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      <main
        id="main-layout"
        className={`bg-primary-purple  min-h-full ${customStyles.main} overflow-y-auto sm:bg-transparent flex flex-col scroll-smooth`}
      >
        <div
          className={`${customStyles.backdrop} w-1/3 h-full absolute top-0 left-1/2 -translate-x-1/2`}
        ></div>
        {children}
